...
[Home](./index.md) &gt; [@jiangshengdev/calcium](./calcium.md) &gt; [BinaryHeap](./calcium.binaryheap.md)
...
|  [push(element)](./calcium.binaryheap.push.md) |  | Pushes a new element onto the binary heap. |
